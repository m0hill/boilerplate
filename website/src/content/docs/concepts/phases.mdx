...
A binding is a single `Binding.Service` whose setup Effect does two
things — and the phase decides how much of it runs:
...
how `Bind(resource)` wires resources into your handler.
