...
[Effect AI](/guides/effect-ai) provider, and fixes streaming
...
The [Effect AI guide](/guides/effect-ai) covers the provider
pattern (reading keys with `Config.redacted`, chat persistence),
and the [AI Gateway tutorial](/tutorial/cloudflare/ai-gateway)
...
- [Effect AI guide](/guides/effect-ai)
- [AI Gateway tutorial](/tutorial/cloudflare/ai-gateway)
