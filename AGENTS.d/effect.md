...
- Keep raw Cloudflare bindings at `src/server.tsx`, `src/cloudflare-env.ts`, or focused external adapter seams; adapt them into narrow services before feature/domain code uses them.
