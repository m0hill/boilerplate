...
[Concepts › Secrets and Config](/concepts/secrets) for the new
model.
:::
...
[Effect RPC](/guides/effect-rpc) boilerplate down to "hand me an
Effect RPC schema."
...
[Effect RPC guide](/guides/effect-rpc), nearly identical for
...
[RpcWorker tutorial](/tutorial/cloudflare/rpc-worker).
...
The [RpcDurableObject tutorial](/tutorial/cloudflare/rpc-durable-object)
...
- **`Cloudflare` Browser Rendering binding** — bind headless
  ...
  **[Alex](https://github.com/gogl-alex)**
...
- [Concepts › Secrets and Config](/concepts/secrets)
- [RpcWorker tutorial](/tutorial/cloudflare/rpc-worker)
- [RpcDurableObject tutorial](/tutorial/cloudflare/rpc-durable-object)
